    ...
    <div class="p-6 flex space-x-2">
        ...
        <div class="flex-1">
            <div class="flex justify-between items-center">
                <div>
                    {{ chirp.user.name }}
                    <small class="ml-2 text-sm text-gray-600 dark:text-gray-400">{{ dayjs(chirp.created_at).fromNow() }}</small>
                    <small v-if="chirp.created_at !== chirp.updated_at" class="text-sm text-gray-600 dark:text-gray-400"> &middot; edited</small>
                </div>
